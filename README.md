...
BOLTCAR is a high-throughput Python-based pipeline to automatically identify, refine, and analyze transition states (TS) and reaction pathways based on Gaussian output files. It extends the FASTCAR approach (DOI	https://doi.org/10.1039/D4CP01721H) by integrating conformer pruning (CREST + RMSD), intrinsic reaction coordinate (IRC) validation, stationary point analysis, and Boltzmann-weighted kinetic modeling.
